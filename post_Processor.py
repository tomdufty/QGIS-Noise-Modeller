...
class QgisNM:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&QgisNoiseModeller')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'QgisNM')
        self.toolbar.setObjectName(u'QgisNM')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/QgisNM/icon.png'
        self.add_action(
            icon_path,
